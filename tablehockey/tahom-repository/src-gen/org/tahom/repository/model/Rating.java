...
public class Rating implements Serializable {
  ...
  public final static String ORDER_BY_RATING_POINTS = "RATING_POINTS";
  ...
  public Rating _setId(final Integer id) {
    this.id = id;
    return this;
  }
  ...
  public void setRatingPoints(final RatingPoints ratingPoints) {
    this.ratingPoints = ratingPoints;
  }
  
  public Rating _setRatingPoints(final RatingPoints ratingPoints) {
    this.ratingPoints = ratingPoints;
    return this;
  }
  
  private List<Tournament> tournament = new java.util.ArrayList<Tournament>();
  
  public List<Tournament> getTournament() {
    return this.tournament;
  }
  
  public void setTournament(final List<Tournament> tournament) {
    this.tournament = tournament;
  }
  
  public Rating _setTournament(final List<Tournament> tournament) {
    this.tournament = tournament;
    return this;
  }
  ...
  public Rating _setOnlyIds_(final boolean onlyIds_) {
    this.onlyIds_ = onlyIds_;
    return this;
  }
  ...
  public Rating _setIds_(final List<Integer> ids_) {
    this.ids_ = ids_;
    return this;
  }
  ...
  public String toStringFull() {
    return "Rating [id=" + id + ", ratingPoints=" + ratingPoints + ", tournament=" + tournament + ", onlyIds_=" + onlyIds_ + ", ids_=" + ids_ + "]";
  }
  ...
  public void setNull_(final Rating.Attribute... attributes) {
    if (attributes == null)
  ...
  public Rating _setNull_(final Rating.Attribute... attributes) {
    setNull_(attributes);
    return this;
  }
  
  public void clearNull_(final Rating.Attribute... attributes) {
    if (attributes == null)
    	throw new IllegalArgumentException();
    for (Attribute attribute : attributes)
  ...
  public Rating _clearNull_(final Rating.Attribute... attributes) {
  ...
  public Rating _setNull_(final String... attributes) {
    setNull_(attributes);
    return this;
  }
  ...
  public Rating _clearNull_(final String... attributes) {
    clearNull_(attributes);
    return this;
  }
  
  public Boolean isNull_(final Rating.Attribute attribute) {
    if (attribute == null)
    	throw new IllegalArgumentException();
  ...
  public void setInit_(final Rating.Association... associations) {
  ...
  public Rating _setInit_(final Rating.Association... associations) {
    setInit_(associations);
    return this;
  }
  
  public void clearInit_(final Rating.Association... associations) {
    if (associations == null)
    	throw new IllegalArgumentException();
    for (Association association : associations)
  ...
  public Rating _clearInit_(final Rating.Association... associations) {
  ...
  public Rating _setInit_(final String... associations) {
    setInit_(associations);
    return this;
  }
  ...
  public Rating _clearInit_(final String... associations) {
    clearInit_(associations);
    return this;
  }
  
  public Boolean toInit_(final Rating.Association association) {
    if (association == null)
    	throw new IllegalArgumentException();
  ...
  public void setOp_(final String operator, final Rating.OpAttribute... attributes) {
    if (attributes == null)
    	throw new IllegalArgumentException();
  ...
  public Rating _setOp_(final String operator, final Rating.OpAttribute... attributes) {
    setOp_(operator, attributes);
    return this;
  }
  
  public void clearOp_(final Rating.OpAttribute... attributes) {
    if (attributes == null)
    	throw new IllegalArgumentException();
    for (OpAttribute attribute : attributes)
  ...
  public Rating _clearOp_(final Rating.OpAttribute... attributes) {
    clearOp_(attributes);
    return this;
  }
  ...
  public Rating _setOp_(final String operator, final String... attributes) {
    setOp_(operator, attributes);
    return this;
  }
  ...
  public Rating _clearOp_(final String... attributes) {
    clearOp_(attributes);
    return this;
  }
  
  public void setNullOp_(final Rating.OpAttribute... attributes) {
    if (attributes == null)
    	throw new IllegalArgumentException();
    for (OpAttribute attribute : attributes)
  ...
  public Rating _setNullOp_(final Rating.OpAttribute... attributes) {
  ...
  public Rating _setNullOp_(final String... attributes) {
    setNullOp_(attributes);
    return this;
  }
