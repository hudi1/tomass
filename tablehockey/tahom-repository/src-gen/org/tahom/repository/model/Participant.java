...
public class Participant implements Serializable {
  ...
  public Participant(final Integer points, final Integer tournamentId, final Player player, final Score score) {
    super();
    setPoints(points);
  ...
  public Participant _setTournamentId(final Integer tournamentId) {
    this.tournamentId = tournamentId;
    return this;
  }
  ...
  public Participant _setSecondaryRank(final Integer secondaryRank) {
    this.secondaryRank = secondaryRank;
    return this;
  }
  ...
  public String toString() {
    return "Participant [id=" + id + ", points=" + points + ", rank=" + rank + ", tournamentId=" + tournamentId + ", score=" + score + ", secondaryRank=" + secondaryRank + ", temp=" + temp + "]";
  }
  
  public String toStringFull() {
    return "Participant [id=" + id + ", points=" + points + ", rank=" + rank + ", tournamentId=" + tournamentId + ", group=" + group + ", player=" + player + ", score=" + score + ", secondaryRank=" + secondaryRank + ", temp=" + temp + ", games=" + games + ", playOffGames=" + playOffGames + ", onlyIds_=" + onlyIds_ + ", ids_=" + ids_ + "]";
  }
