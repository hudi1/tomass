...
public class Game implements Serializable {
  ...
  public final static String ORDER_BY_HOME_GROUP_PARTICIPANT = "HOME_GROUP_PARTICIPANT";
  
  public final static String ORDER_BY_AWAY_GROUP_PARTICIPANT = "AWAY_GROUP_PARTICIPANT";
  
  public Game() {
  }
  
  public Game(final GroupParticipant homeGroupParticipant, final GroupParticipant awayGroupParticipant) {
    super();
    setHomeGroupParticipant(homeGroupParticipant);
    setAwayGroupParticipant(awayGroupParticipant);
  }
  ...
  private GroupParticipant homeGroupParticipant;
  
  public GroupParticipant getHomeGroupParticipant() {
    return this.homeGroupParticipant;
  }
  
  public void setHomeGroupParticipant(final GroupParticipant homeGroupParticipant) {
    this.homeGroupParticipant = homeGroupParticipant;
  }
  
  public Game _setHomeGroupParticipant(final GroupParticipant homeGroupParticipant) {
    this.homeGroupParticipant = homeGroupParticipant;
    return this;
  }
  
  private GroupParticipant awayGroupParticipant;
  
  public GroupParticipant getAwayGroupParticipant() {
    return this.awayGroupParticipant;
  }
  
  public void setAwayGroupParticipant(final GroupParticipant awayGroupParticipant) {
    this.awayGroupParticipant = awayGroupParticipant;
  }
  
  public Game _setAwayGroupParticipant(final GroupParticipant awayGroupParticipant) {
    this.awayGroupParticipant = awayGroupParticipant;
    return this;
  }
  ...
  public Game _setMatchs(final List<Matchs> matchs) {
    this.matchs = matchs;
    return this;
  }
  ...
  public String toStringFull() {
    return "Game [id=" + id + ", homeGroupParticipant=" + homeGroupParticipant + ", awayGroupParticipant=" + awayGroupParticipant + ", result=" + result + ", status=" + status + ", matchs=" + matchs + ", onlyIds_=" + onlyIds_ + ", ids_=" + ids_ + "]";
  }
  ...
  public enum Association {
    homeGroupParticipant,
    
    awayGroupParticipant,
