...
public class Groups implements Serializable {
  ...
  public Groups(final String name, final Stage stage) {
    super();
    setName(name);
    setStage(stage);
  }
  ...
  public Groups _setStage(final Stage stage) {
    this.stage = stage;
    return this;
  }
  ...
  public Groups _setGroupParticipants(final List<GroupParticipant> groupParticipants) {
    this.groupParticipants = groupParticipants;
    return this;
  }
  ...
  public Groups _setMatchs(final List<Matchs> matchs) {
    this.matchs = matchs;
    return this;
  }
  ...
  public String toStringFull() {
    return "Groups [id=" + id + ", name=" + name + ", stage=" + stage + ", groupParticipants=" + groupParticipants + ", matchs=" + matchs + ", onlyIds_=" + onlyIds_ + ", ids_=" + ids_ + "]";
  }
