...
public class PlayingFormat implements Serializable {
  ...
  public String toStringFull() {
    return "PlayingFormat [id=" + id + ", name=" + name + ", finalPromoting=" + finalPromoting + ", lowerPromoting=" + lowerPromoting + ", winPoints=" + winPoints + ", playOffFinal=" + playOffFinal + ", playOffLower=" + playOffLower + ", minPlayersInGroup=" + minPlayersInGroup + ", sortType=" + sortType + ", description=" + description + ", onlyIds_=" + onlyIds_ + ", ids_=" + ids_ + "]";
  }
