...
public class Stage implements Serializable {
  ...
  public String toStringFull() {
    return "Stage [id=" + id + ", name=" + name + ", sequence=" + sequence + ", numberOfHockey=" + numberOfHockey + ", winPoints=" + winPoints + ", type=" + type + ", tournament=" + tournament + ", status=" + status + ", copyResultStage=" + copyResultStage + ", groups=" + groups + ", playOffGames=" + playOffGames + ", onlyIds_=" + onlyIds_ + ", ids_=" + ids_ + "]";
  }
