...
public class FinalStanding implements Serializable {
  ...
  public FinalStanding(final Integer finalRank) {
    super();
  ...
  public FinalStanding _setParticipant(final Participant participant) {
    this.participant = participant;
    return this;
  }
  ...
  public String toStringFull() {
    return "FinalStanding [id=" + id + ", participant=" + participant + ", finalRank=" + finalRank + ", onlyIds_=" + onlyIds_ + ", ids_=" + ids_ + "]";
  }
